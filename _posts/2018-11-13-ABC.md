...
![Caption for the picture.](https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/A_dynamic_bistable_hidden_Markov_model.svg/326px-A_dynamic_bistable_hidden_Markov_model.svg.png){width=50%}[Wikipedia, 2018]
...
**Algorithm 2 : ** ABC-REJ algorithm
 ...
 3. $\quad \quad$ **Generate** $\theta \sim \pi(\theta)$
 4. $\quad \quad$ **Generate** $\tilde{x} \sim p(x \:| \: \theta)$
 5. $\quad \quad$ **if** $\begin{aligned} d(T( \tilde{x}) , T(x^{*} )) \leq \epsilon \end{aligned}$ **then**
 6. $\quad \quad \quad$ accept $\theta$.
 7. $\quad \quad$ **else** 
 8. $\quad \quad \quad$ reject $\theta$.
 9. **until** $\# \: \text{of} \: \theta = K$
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/A_dynamic_bistable_hidden_Markov_model.svg/326px-A_dynamic_bistable_hidden_Markov_model.svg.png){width=50%}[Wikipedia, 2018]
...
| **i** | $\theta_i$ | $\begin{aligned} \textrm{Simulated data} (\tilde{x}) \end{aligned}$ | | T($\begin{aligned}\cdot \end{aligned}$) | **Distance** |  **Outcome** |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|1|0.08|$\begin{aligned}AABAAAABA\cdots \end{aligned}$||8|2|accepted|
|2|0.68|$\begin{aligned}AABBABABA\cdots \end{aligned}$||13|7|rejected|
|3|0.87|$\begin{aligned}BBBABBABB\cdots \end{aligned}$||9|3|rejected|
|4|0.43|$\begin{aligned}AABAAAAAB\cdots \end{aligned}$||6|0|accepted|
|5|0.53|$\begin{aligned}ABBBBBAAB\cdots \end{aligned}$||9|3|rejected|
...
points(density(pos.theta)$x, density(pos.theta)$y, col = "red", type = "l")
```
